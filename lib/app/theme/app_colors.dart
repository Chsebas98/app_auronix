...
class AppColors {
  ...
  static const third = Color(0xFFFFC900);
  static const fourth = Color(0xFFB3B3B4);
  static const fifth = Color(0xFF00B292);
  static const sixth = Color(0xFF00B393);
  static const sevent = Color(0xFFFF3B00);
  static const eight = Color(0xFFB5B5B6);
  static const nineth = Color(0xFFF9D659);
  static const tenth = Color(0xFFF99C59);
  static const eleventh = Color(0xFF00D16C);
  static const twelveth = Color(0xFFFFC107);

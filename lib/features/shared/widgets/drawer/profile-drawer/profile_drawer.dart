    ...
    return Padding(
      ...
      child: OutlinedButton.icon(
        ...
        style: OutlinedButton.styleFrom(
          foregroundColor: AppColorsExtension.buttonColor(context),
          // iconColor: AppColorsExtension.iconColor(context),
          side: BorderSide(
            color: AppColorsExtension.borderPrimaryColor(context),
            width: 1.5,
          ),
